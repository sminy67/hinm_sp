...
export YAML_NAME=obs_216v128_perm_gradual_pair
...
CUDA_VISIBLE_DEVICES=3 python3.10 src/sparseml/transformers/question_answering.py \
...
--report_to none \
--output_dir integrations/huggingface-transformers/output_dir/test_OBS_216v128_perm_pairwise