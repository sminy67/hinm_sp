...
__all__ = [
    ...
    "OBS28v64pairPermPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28v64pairPermPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS28v64pairPermPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28v64pairPermPruningParamsScorer(
            params=params,
