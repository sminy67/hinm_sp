...
__all__ = [
    "OBS216v64pairPermPruningModifier",
    "OBS216v64pairPermPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS216v64pairPermPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS216v64pairPermPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS216v64pairPermPruningParamsScorer(
            params=params,
...
class OBS216v64pairPermPruningParamsScorer(PruningParamsGradScorer):
    """
