...
__all__ = [
    "OBS28v128pairPermPruningModifier",
    "OBS28v128pairPermPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS28v128pairPermPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS28v128pairPermPruningModifier")
        if (
    ...
    def check_mask_update(
        ...
        if self._last_applied_sparsity == 0.5:
            to_apply_sparsities = [0.75] * len(to_apply_sparsities)
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS28v128pairPermPruningParamsScorer(
            params=params,
...
class OBS28v128pairPermPruningParamsScorer(PruningParamsGradScorer):
    """
