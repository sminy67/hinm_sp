...
import itertools
from .permutations import apply_out_perm, apply_gyro_perm
import torch.profiler
import numpy as np

__all__ = [
    "OBS216v128pairPermPruningModifier",
    "OBS216v128pairPermPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBS216v128pairPermPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBS216v128pairPermPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBS216v128pairPermPruningParamsScorer(
            params=params,
...
class OBS216v128pairPermPruningParamsScorer(PruningParamsGradScorer):
    """
    ...
    def score_parameters(self) -> List[Tensor]:
        ...
        nm = {0.0:(4,16), 0.25:(6,16), 0.375:(8,16), 0.5:(10,16), 0.625:(12,16), 0.75:(14,16)}

        sparsity = self._last_applied_sparsity
        n_el, m_el = nm[sparsity]
        vec_size = 128
        vec_sparsity = (n_el / m_el) if sparsity < 0.75 else 0.75
        n,m = (0, 0) if sparsity != 0.75 else (2, 4)
